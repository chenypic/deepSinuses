...
class UNet3D(Abstract3DUNet):
    ...
    def __init__(self, in_channels=1, out_channels=1, final_sigmoid=True, f_maps=16, layer_order='bcr',
                 num_groups=4, num_levels=4, is_segmentation=True, conv_padding=1):
